...
from supabaseconn import get_patient_demographics, insert_row, update_row
...
def set_ai_extracted(consultation_id: Any, extracted_json: dict) -> dict:
    """
...
if __name__ == "__main__":
    # ---- Predefined config ----
    INPUT_FILE = "structured_consultation.json"
    ...
    while True:
        ...
        try:
            ...
            # ---- STAGE 3: ai_extracted ----
                ...
                set_ai_extracted(consultation_id, updated)
                print(f"[ai_extracted]   extracted_data set "
                      f"(age={updated['extracted_data']['age']}, "
                      f"sex={updated['extracted_data']['sex']})")
